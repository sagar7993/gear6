function order_type_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/order_type_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
...
function pick_up_analysis(atype) {
	...
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/pick_up_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function delay_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/delay_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function order_summary_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/order_summary_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function status_type_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/status_type_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function future_orders_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/future_orders_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function next_week_analysis() {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/next_week_analysis",
		data: {atype: null},
		dataType: "json",
		cache: false,
		success: function(data) {
...
function sc_order_type_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/sc_order_type_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
			...
			for (var i = 0; i < data.services.length; i++) {
				series.push({
					...
					data: data[data.services[i]]
				});
			}
			$('#sc_order_type_analysis').highcharts({
				chart: {
					type: 'column'
				},
				title: {
...
function sc_breakdown_analysis(atype) {
	$.ajax({
		type: "POST",
		url: "/prvendor/bizhome/sc_breakdown_analysis",
		data: {atype: atype},
		dataType: "json",
		cache: false,
		success: function(data) {
			...
			$('#sc_breakdown_analysis').highcharts({
				chart: {
					type: 'column'
				},
				title: {
...
$(function() {
	...
	sc_order_type_analysis('Weekly');
	sc_breakdown_analysis('Weekly');
	next_week_analysis();
