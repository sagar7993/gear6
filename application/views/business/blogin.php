...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Business Home - Login</title>
...
<body>
	...
	<main>
		...
		<div class="vlogin-wrapper" id="agent_rpwd" style="display:none">
			...
			<form method="POST" action="/home/resetpwd_biz">
			<div class="boxShadow">
				<div class="row no-row">
					<div class="col s12 inp-wrapper margin-top-n5">
						<i class="material-icons">vpn_key</i>
