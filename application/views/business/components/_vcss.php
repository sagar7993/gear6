...
<link rel="stylesheet" type="text/css" href="<?php echo site_url('fonts/css/iconset.min.css'); ?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo site_url('css/media.css'); ?>">
