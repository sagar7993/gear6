<?php if(isset($b_is_first_time) && $b_is_first_time == 1) { ?>
...
<header class="header">
	<nav role="navigation">
		...
		<div class="nav-wrapper">
			<a href="<?php echo base_url('business/bizhome'); ?>" class="left hide-on-med-and-down padding-10px clear-hover-bg">
				<img src="<?php echo site_url('img/mr_logo.png'); ?>" class="left header-logo" />
			</a>
			<a href="<?php echo base_url('business/bizhome'); ?>" id="nav-desktop" class="right hide-on-large-only padding-10px clear-hover-bg">
			...
			<ul class="right hide-on-med-and-down">
				...
				<li>
					<a href="#" id="af_login_dw" class='dropdown-button' data-activates='user_menu'>
						...
						<span><?php echo convert_to_camel_case($this->session->userdata('b_name')); ?></span>
					</a>
					<ul class="dropdown-content custom-dd" id="user_menu">
						<li role="presentation">
							<a href="<?php echo base_url('business/bizhome'); ?>" ><i class="nav-icon material-icons left">dashboard</i><span>Dashboard</span></a>
						</li>
						<li role="presentation" class="divider"></li>
						<li role="presentation"><a href="/home/biz_logout/<?php echo base64_encode(current_url()); ?>"><i class="nav-icon material-icons left">open_in_browser</i><span>Logout</span></a></li>
					</ul>
				</li>
			</ul>
			<?php } else { ?>
