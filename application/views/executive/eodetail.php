			...
			<li>
				...
				<div class="collapsible-body">
					<div class="review-options-container row">
						...
						<div class="col s12 m6 margin-top-22px">
							<label for="exampleInputPassword1">Customer Support Comments</label><br/>
							<label class="selected-options">
								<b>
								<?php if(isset($cs_comments)) { foreach ($cs_comments as $comment) { ?>
									<ul>
										<li>
											<?php echo $comment["remarks"] . " (" . $comment["timestamp"] . ")" ?>
										</li>
									</ul>
								<?php } } ?>
								</b>
