...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Privileged Vendors Panel - Serviced Orders</title>
							...
							<div class="box-body">
								<div class="row">
									<div class="col-md-4 text-center">
										<input type="text" class="knob" data-max="500" readonly value="<?php if (isset($s_count)) { echo $s_count; } ?>" data-skin="tron" data-thickness="0.2" data-width="120" data-height="120" data-fgColor="#00a65a"/>
										<div class="knob-label">Serviced - Yet to Deliver</div>
									</div><!-- ./col -->
									<div class="col-md-4 text-center">
										<input type="text" class="knob" data-max="500" readonly value="<?php if (isset($d_count)) { echo $d_count; } ?>" data-skin="tron" data-thickness="0.2" data-width="120" data-height="120" data-fgColor="#f56954"/>
										<div class="knob-label">Delayed Services</div>
									</div><!-- ./col -->
									<div class="col-md-4 text-center">
										<input type="text" class="knob" data-max="500" readonly value="1" data-skin="tron" data-thickness="0.2" data-width="120" data-height="120" data-fgColor="#932ab6"/>
