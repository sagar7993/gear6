...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Privileged Vendors Panel - Allotted Orders</title>
						...
						<div class="box box-solid">
							...
							<div class="box-body">
								<div class="row">
									...
									<div class="col-md-4 text-center">
										<input type="text" class="knob" data-max="500" readonly value="<?php if (isset($r_count)) { echo $r_count; } ?>" data-skin="tron" data-thickness="0.2" data-width="120" data-height="120" data-fgColor="#f56954"/>
