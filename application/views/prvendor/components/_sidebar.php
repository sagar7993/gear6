	...
	<section class="sidebar">
		<section>
			<div class="sidebar-title">
				...
				<div>
					&nbsp;<?php echo convert_to_camel_case($this->session->userdata('prv_role')); ?>
				</div>
			</div>
		</section>
		<ul class="sidebar-menu">
			...
			<li class="side-menu-list side-menu-inactive" id="upcoming">
				<a href="<?php echo base_url('prvendor/upcoming'); ?>">
			...
			<li class="side-menu-list side-menu-inactive" id="unallot">
				<a href="<?php echo base_url('prvendor/unallotted'); ?>">
			...
			<li class="side-menu-list side-menu-inactive" id="allot">
				<a href="<?php echo base_url('prvendor/allotted'); ?>">
			...
			<li class="side-menu-list side-menu-inactive" id="serviced">
				<a href="<?php echo base_url('prvendor/serviced'); ?>">
			...
			<li class="side-menu-list side-menu-inactive" id="history">
				<a href="<?php echo base_url('prvendor/archived'); ?>">
