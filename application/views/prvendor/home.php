...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Privileged Vendor Home - Dashboard</title>
						...
						<div class="col-md-12">
							<div class="box box-solid">
								<div class="box-header dash-box-header">
									...
									<h5 class="box-title font16">Service Center Orders Analysis - Monthly/All</h5>
								</div><!-- /.box-header -->
								<div class="box-body">
											...
											<div class="checkbox" id="toggle-grp">
												<label>
													<div class="btn-group btn-toggle form-group toggle-btn"> 
														<button class="btn btn-xs btn-primary active tog-btn">Monthly</button>
														<button class="btn btn-xs btn-default tog-btn">All</button>
													</div>
												</label>
											</div>
											<div id="sc_order_type_analysis" style="height:300px"></div>
										</div>
									</div><!-- /.box-body -->
								</div><!-- /.box -->
							</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-solid">
								<div class="box-header dash-box-header">
									<i class="fa fa-bar-chart-o"></i>
									<h5 class="box-title font16">Service Center Breakdown Analysis - Monthly/All</h5>
								</div><!-- /.box-header -->
								<div class="box-body">
									<div class="row analysis-container">
										<div class="col-md-12">
											...
											<div id="sc_breakdown_analysis" style="height:300px"></div>
										</div>
									</div><!-- /.box-body -->
								</div><!-- /.box -->
							</div>
...
<script type="text/javascript" src="<?php echo site_url('js/prdash.js'); ?>"></script>
<script>
</script>
</body>
</html>