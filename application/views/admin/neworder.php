...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Place Order - Admin Panel</title>
		...
		<aside class="right-side">
			...
			<section class="content">
				<div class="row">
						...
						<div class="row">
							<div class="pickup-title teal-bold">Start Typing Service Center Name</div>
						...
						<div class="row" id="main_placeorder_page">
							<div class="row">
								...
								<div class="form-group col-xs-6">
									<input data-type="phone" data-mandatory="true" data-error="Phone Number" type="text" class="form-control" placeholder="Enter the user phone number (10 digits)" name="phone" id="phone_num" />
							...
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<div class="form-group col-xs-2">
										<input data-type="regnum" data-mandatory="true" data-error="Reg No." type="text" class="form-control" name="reg_num" id="reg_num" placeholder="Reg No.">
									</div>
									<div class="form-group col-xs-2">
										<input data-type="bikenum" data-mandatory="true" data-error="Bike Number" type="text" class="form-control" name="bike_num" id="bike_num" placeholder="User Bike Number">
									</div>
								</div>
								<div class="col-xs-8">
									<div class="form-group col-xs-6">
