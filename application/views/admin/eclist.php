...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - PUCs - Admin Panel</title>
		...
		<aside class="right-side">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">PUCs Dashboard</li>
				</ol>
			</section>
			<section>
					...
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								...
								<th class="last"><i class="fa fa-motorcycle"></i> &nbsp;&nbsp;License Expiry</th>
							</tr>
						</thead>
						<tbody> 
