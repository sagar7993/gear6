...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Puncture Portal - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					Dashboard
					<small>Puncture Portal</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Punctures Portal</li>
				</ol>
			</section>
			<section>
				<div class="row" id="parameters">
					<div class="col-xs-12">
						...
						<div class="col-xs-4 field-box">
							 <button class='next btn btn-primary btnUpdate-pu' id="punctureButton" disabled>Fetch Puncture Shops</button>
						</div>
					</div>
				</div>
						...
						<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
							<thead>
								<tr>
									...
									<th><i class="fa fa-cog"></i> &nbsp;&nbsp;Puncture Center Name</th>
							...
							<tbody> 
								...
								<tr id="<?php echo $count; ?>">
									...
									<td><?php echo convert_to_camel_case($row['ScName']); ?></a></td>
...
<script type="text/javascript">
	...
	$('#punctureButton').on('click', function(e) {
		var form = '<form action="/admin/orders/get_ptlist" method="POST">';
