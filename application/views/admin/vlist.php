...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Vendors List - Admin Panel</title>
					...
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								...
								<th><i class="fa fa-sitemap"></i> &nbsp;&nbsp;Orders</th>
								<th><i class="fa fa-star"></i> &nbsp;&nbsp;Rating</th>
								<th class="last"><i class="fa fa-star"></i> &nbsp;&nbsp;Login as Vendor</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr id="sc_<?php echo $row['ScId']; ?>">
								...
								<td><?php echo $row['OCount']; ?></td>
								<td class="rate_it_i_say"><?php echo $row['Rating']; ?></td>
								<td><a target="_blank" href="<?php echo site_url('admin/vendors/loginasvendor/' . $row['ScId']); ?>" class="order-id-link">Login</a></td>
							</tr>
							<?php } } ?>
						</tbody>
						<tfoot>
