...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - UnApproved Puncture Centers - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					Puncture Centers
					<small>UnApproved Puncture Centers</small>
				</h1>
				<ol class="breadcrumb">
			...
			<section>
				<div id="detail_tab" class="table-margin-top">
					<form method="POST" action="/admin/approvals/ptapprove">
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								<th class="first"><i class="fa fa-bookmark"></i> &nbsp;&nbsp;Puncture Center Name</th>
						...
						<tbody> 
							...
							<tr id="<?php echo $count; ?>">
								<td><a href="" class="order-id-link"><?php echo convert_to_camel_case($row['ScName']); ?></a></td>
								...
								<td>
									<div class="checkbox" style="">
										<label class="price">
											<input type="checkbox" class="app_vendors" name="sc_ids[]" value="<?php echo $row['PTScId']; ?>">
										</label>
									</div>
								</td>
							</tr>
