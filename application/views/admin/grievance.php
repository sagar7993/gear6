...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Grievance Orders - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content">
				<label class="selected-options">&nbsp;&nbsp;&nbsp;&nbsp;Filter Orders</label>
				<div class="row">
					<div class="col-xs-12">
						<div class="col-xs-3">
							<div class="checkbox" style="">
								<label class="search-filter">
									<input type="radio" name="search-filter" class="odstatusfilter" value="oiasa89w48kfoweo9234ife" id="radio_1">
									<span style="margin-left:15px">Not Approved</span>
								</label>
							</div>
						</div>
						<div class="col-xs-2">
							<div class="checkbox" style="">
								<label class="search-filter">
									<input type="radio" name="search-filter" class="odstatusfilter" value="aviawefiw98r23k4of9ekng" id="radio_2">
						...
						<div class="col-xs-3">
							<div class="checkbox" style="">
								<label class="search-filter">
									<input type="radio" name="search-filter" class="odstatusfilter" value="dslfgliearoi345ksfe" id="radio_3">
									<span style="margin-left:15px">Bike Checked</span>
								</label>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="checkbox" style="">
								<label class="search-filter">
									<input type="radio" name="search-filter" class="odstatusfilter" value="asdava9dwr4kl32l" id="radio_4">
									<span style="margin-left:15px">Service Started</span>
								</label>
							</div>
						</div>
						<div class="col-xs-1">
			...
			<section>
				<div align="center"><h5>Grievance Orders</h5></div>
					...
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						...
						<tbody>
							...
							<tr id="<?php echo $count; ?>">
								<td data-search="<?php echo $search_flag[intval($row['sorder'])] . " " . $row['oid']; ?>">
									<a href="<?php echo site_url('admin/orders/odetail/' . $row['oid']); ?>"
									class="order-id-link">
										<?php echo $row['oid']; ?>
									</a>
								</td>
