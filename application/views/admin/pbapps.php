...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - UnApproved Petrol Bunks - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					PetrolBunks
					<small>UnApproved PetrolBunks</small>
				</h1>
				<ol class="breadcrumb">
			...
			<section>
				<div id="detail_tab" class="table-margin-top">
					<form method="POST" action="/admin/approvals/pbapprove">
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								<th class="first"><i class="fa fa-bookmark"></i> &nbsp;&nbsp;Bunk Name</th>
						...
						<tbody> 
							...
							<tr id="<?php echo $count; ?>">
								<td><a href="" class="order-id-link"><?php echo convert_to_camel_case($row['PBName']); ?></a></td>
								...
								<td>
									<div class="checkbox" style="">
										<label class="price">
											<input type="checkbox" class="app_vendors" name="sc_ids[]" value="<?php echo $row['PBId']; ?>">
										</label>
									</div>
								</td>
							</tr>
