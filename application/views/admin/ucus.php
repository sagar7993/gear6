...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - User Requests - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					Overview
					<small>User ContactUs Requests</small>
				</h1>
				<ol class="breadcrumb">
					...
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								...
								<th><i class="fa fa-whatsapp"></i> &nbsp;&nbsp;Message</th>
						...
						<tbody> 
							...
							<tr id="<?php echo $count; ?>">
								<td><?php echo convert_to_camel_case($row['Name']); ?></td>
						...
						<tfoot>
							<tr>
								...
								<th><i class="fa fa-gears"></i> &nbsp;&nbsp;Email</th>
								<th><i class="fa fa-whatsapp"></i> &nbsp;&nbsp;Message</th>
								<th class="last"><i class="fa fa-calendar"></i> &nbsp;&nbsp;TimeStamp</th>
							</tr>
						</tfoot>
					</table>
				</div>
