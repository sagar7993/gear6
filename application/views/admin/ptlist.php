...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Puncture Centers - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					Dashboard
					<small>Puncture Centers</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Punctures Dashboard</li>
				</ol>
			</section>
			<section>
					...
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								...
								<th class="last"><i class="fa fa-whatsapp"></i> &nbsp;&nbsp;Location</th>
							</tr>
						</thead>
						<tbody> 
