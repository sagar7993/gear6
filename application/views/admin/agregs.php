...
<head>
	<meta charset="UTF-8">
	<title><?php if(isset($site_name)) { echo $site_name; } ?> - Agent Requests - Admin Panel</title>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				<h1>
					Overview
					<small>Agent Registration Requests</small>
				</h1>
				<ol class="breadcrumb">
			...
			<section>
				<div id="detail_tab" class="table-margin-top">
					<table id="example1" border="0" cellpadding="0" cellspacing="0" class="table custom-table">
						<thead>
							<tr>
								<th class="first"><i class="fa fa-bookmark"></i> &nbsp;&nbsp;Service Center Name</th>
								<th><i class="fa fa-calendar"></i> &nbsp;&nbsp;Contact Person</th>
								<th><i class="fa fa-gears"></i> &nbsp;&nbsp;Email</th>
								<th><i class="fa fa-whatsapp"></i> &nbsp;&nbsp;Phone</th>
								<th><i class="fa fa-whatsapp"></i> &nbsp;&nbsp;Service Center Type</th>
							</tr>
						</thead>
						<tbody> 
							...
							<tr id="<?php echo $count; ?>">
								...
								<td><?php echo convert_to_camel_case($row['ContactPerson']); ?></td>
								<td><?php echo $row['Email']; ?></td>
								<td><?php echo $row['Phone']; ?></td>
								<td><?php echo $row['ScType']; ?></td>
							</tr>
							<?php $count += 1; } } ?>
						</tbody>
						<tfoot>
