<?php
class Odetail extends G6_Bizcontroller {
	public function __construct() {
		parent::__construct();
	}
	public function index($oid = NULL) {
		redirect(site_url('business/odetail/show/' . $oid));
	}
	public function show($oid = NULL) {
		if($oid === NULL || !$this->is_valid_oid($oid)) {
			...
			$this->load->view('business/odetail', $this->data);
		}
	}
	public function send_thankyou() {
		if($_POST) {
			...
			redirect('/business/odetail/show/' . $oid);
		}
	}
